# Connecting a Form to Google Sheets
...
Open the file named `index.html`. On line 24 replace `<SCRIPT URL>` with your script url:
...
Please [create a new issue](https://github.com/maxunspecified/email-sublist-form/issues). PRs are definitely welcome, but please run your ideas by me before putting in a lot of work. Thanks!
